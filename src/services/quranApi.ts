...
export const everyAyahReciters: EveryAyahReciter[] = [
  ...
  },
  {
    ...
    nameAr: 'أحمد بن علي العجمي (كتاب الله)',
    nameEn: 'Ahmed al-Ajamy KetabAllah',
    style: 'ترتيل',
    bitrate: '128kbps',
  },
  ...
  // ==================== قراء آخرين والأكثر طلباً ====================
  {
    id: 'ali_jaber_64',
    subfolder: 'Ali_Jaber_64kbps',
    nameAr: 'علي جابر (إمام الحرم)',
    nameEn: 'Ali Jaber',
    style: 'ترتيل',
    bitrate: '64kbps',
  },
  ...
  },
  {
    ...
    nameAr: 'عبد الباسط عبد الصمد (ورش)',
