...
export const TitleBar: React.FC = () => {
  return (
    <div className="drag-region relative w-full h-9 flex items-center justify-between bg-surface-950/80 backdrop-blur-sm border-b border-surface-700/30 shrink-0 z-[200] select-none">
      ...
      <div className="pointer-events-none flex items-center gap-2 px-4">
        ...
        <span className="text-xs text-surface-400 font-medium whitespace-nowrap font-arabic">
      ...
      <div className="no-drag flex items-center h-full">
        <button
          type="button"
          className="no-drag h-full px-4 flex items-center justify-center text-surface-400 hover:text-surface-50 hover:bg-surface-800/60 transition-colors"
          onClick={() => {
        ...
        <button
          type="button"
          className="no-drag h-full px-4 flex items-center justify-center text-surface-400 hover:text-white hover:bg-red-500 transition-colors"
          onClick={() => {
