...
export const CharityRibbonFooter: React.FC<CharityRibbonFooterProps> = React.memo(
  ({ onOpenMotherDua }) => {
    ...
    return (
      <footer className="w-full bg-gradient-to-r from-surface-950 via-gold-950/25 to-surface-950 border-t border-gold-400/20 py-2.5 px-4 shrink-0 z-20 shadow-lg select-none">
